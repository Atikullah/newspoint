                                            ...
                                            <div class="col-12" style="margin-bottom:25px;margin-top: 23px;">
                                                ...
                                                <div class="card card-info" style="margin:15px;">
                                                    <div class="card-header">
                                                        <h3 class="card-title ">Update Feature </h3>
                                                        <div class="card-tools">
                                                            <router-link to="/feature" class="btn btn-block btn-outline-secondary"> Feature List</router-link>
                                                        </div>
                                                    </div>
                                                    <!-- /.card-header -->
                                                    <!-- form start -->
                                                    <form class="form-horizontal" @submit.prevent="UpdateFeature">
                                                        <div class="card-body">
                                                            <div class="form-group row">
                                                                <label for="name" class="col-sm-2 col-form-label">Feature Name :</label>
                                                                <div class="col-sm-10">
...
export default {
    ...
    methods:{
        UpdateFeature: function (){
            let this_ = this;
            this.form.post('/updatefeature/'+ this.$route.params.name).then((response) => {
                ...
                this_.$router.push("/feature");
            })

        },
        ViewFeature: function () {
            const this_ = this;
            axios.get("/viewfeature/" + this.$route.params.name).then((response) =>{
                this_.form.fill(response.data.showFeature);
