        ...
        <section class="content">
            ...
            <div class="card" style="margin-top: -20px;">
                <div class="card-header">
                    <h3 class="card-title">Update Opinion</h3>
                                            ...
                                            <div class="col-12" style="margin-bottom:25px;margin-top: 23px;">
                                                ...
                                                <div class="card card-info" style="margin:15px;">
                                                    <div class="card-header">
                                                        <h3 class="card-title ">Update Opinion </h3>
                                                        <div class="card-tools">
                                                            <router-link to="/opinion" class="btn btn-block btn-outline-secondary"> Opinion List</router-link>
                                                        </div>
                                                    </div>
                                                    <!-- /.card-header -->
                                                    <!-- form start -->
                                                    <form class="form-horizontal" @submit.prevent="UpdateOpinion">
                                                        <div class="card-body">
                                                            <div class="form-group row">
                                                                <label for="name" class="col-sm-2 col-form-label">Opinion Name :</label>
                                                                <div class="col-sm-10">
...
export default {
    ...
    methods:{
        UpdateOpinion: function (){
            let this_ = this;
            this.form.post('/updateopinion/'+ this.$route.params.name).then((response) => {
                ...
                this_.$router.push("/opinion");
            })

        },
        ViewOpinion: function () {
            const this_ = this;
            axios.get("/viewopinion/" + this.$route.params.name).then((response) =>{
                this_.form.fill(response.data.showOpinion);
