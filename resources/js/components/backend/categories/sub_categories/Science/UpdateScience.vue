        ...
        <section class="content">
            ...
            <div class="card" style="margin-top: -20px;">
                <div class="card-header">
                    <h3 class="card-title">Update Science</h3>
                                            ...
                                            <div class="col-12" style="margin-bottom:25px;margin-top: 23px;">
                                                ...
                                                <div class="card card-info" style="margin:15px;">
                                                    <div class="card-header">
                                                        <h3 class="card-title ">Update Science </h3>
                                                        <div class="card-tools">
                                                            <router-link to="/science" class="btn btn-block btn-outline-secondary"> Science List</router-link>
                                                        </div>
                                                    </div>
                                                    <!-- /.card-header -->
                                                    <!-- form start -->
                                                    <form class="form-horizontal" @submit.prevent="UpdateScience">
                                                        <div class="card-body">
                                                            <div class="form-group row">
                                                                <label for="name" class="col-sm-2 col-form-label">Science Name :</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control " id="name" placeholder="Enter Science Type"
...
export default {
    ...
    methods:{
        UpdateScience: function (){
            let this_ = this;
            this.form.post('/updatescience/'+ this.$route.params.name).then((response) => {
                ...
                this_.$router.push("/science");
            })

        },
        ViewScience: function () {
            const this_ = this;
            axios.get("/viewscience/" + this.$route.params.name).then((response) =>{
                this_.form.fill(response.data.showScience);
