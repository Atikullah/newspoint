        ...
        <section class="content">
            ...
            <div class="card" style="margin-top: -20px;">
                <div class="card-header">
                    <h3 class="card-title">Update Life</h3>
                                            ...
                                            <div class="col-12" style="margin-bottom:25px;margin-top: 23px;">
                                                ...
                                                <div class="card card-info" style="margin:15px;">
                                                    <div class="card-header">
                                                        <h3 class="card-title ">Update Life </h3>
                                                        <div class="card-tools">
                                                            <router-link to="/life" class="btn btn-block btn-outline-secondary"> Life List</router-link>
                                                        </div>
                                                    </div>
                                                    <!-- /.card-header -->
                                                    <!-- form start -->
                                                    <form class="form-horizontal" @submit.prevent="UpdateLife">
                                                        <div class="card-body">
                                                            <div class="form-group row">
                                                                <label for="name" class="col-sm-2 col-form-label">Life Name :</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control " id="name" placeholder="Enter Life Type"
...
export default {
    ...
    methods:{
        UpdateLife: function (){
            let this_ = this;
            this.form.post('/updatelife/'+ this.$route.params.name).then((response) => {
                ...
                this_.$router.push("/life");
            })

        },
        ViewLife: function () {
            const this_ = this;
            axios.get("/viewlife/" + this.$route.params.name).then((response) =>{
                this_.form.fill(response.data.showLife);
