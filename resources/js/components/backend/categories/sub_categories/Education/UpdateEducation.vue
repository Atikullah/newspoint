                                            ...
                                            <div class="col-12" style="margin-bottom:25px;margin-top: 23px;">
                                                ...
                                                <div class="card card-info" style="margin:15px;">
                                                    <div class="card-header">
                                                        <h3 class="card-title ">Update Education </h3>
                                                        <div class="card-tools">
                                                            <router-link to="/education" class="btn btn-block btn-outline-secondary"> Education List</router-link>
                                                        </div>
                                                    </div>
                                                    <!-- /.card-header -->
                                                    <!-- form start -->
                                                    <form class="form-horizontal" @submit.prevent="UpdateEducation">
                                                        <div class="card-body">
                                                            <div class="form-group row">
                                                                <label for="name" class="col-sm-2 col-form-label">Education Name :</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control " id="name" placeholder="Enter Education Type"
...
export default {
    ...
    methods:{
        UpdateEducation: function (){
            let this_ = this;
            this.form.post('/updateeducation/'+ this.$route.params.name).then((response) => {
                ...
                this_.$router.push("/education");
            })

        },
        ViewEducation: function () {
            const this_ = this;
            axios.get("/vieweducation/" + this.$route.params.name).then((response) =>{
                this_.form.fill(response.data.showEducation);
