                                        ...
                                        <div class="row" >
                                            <div class="col-12" style="margin-bottom:25px;margin-top: 23px;">
                                                ...
                                                <div class="card card-info" style="margin:15px;">
                                                    ...
                                                    <!-- /.card-header -->
                                                    <!-- form start -->
                                                    <form class="form-horizontal" @submit.prevent="AddEducation">
                                                        <div class="card-body">
                                                            <div class="form-group row">
                                                                <label for="name" class="col-sm-2 col-form-label">Education Name:</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control " id="name" placeholder="Enter Education name"
...
export default {
    ...
    methods:{
        AddEducation:function (){
            let this_ = this;
            this.form.post('/addeducation').then(function (data){
                //console.log(data);
                Toast.fire({
                    icon: 'success',
