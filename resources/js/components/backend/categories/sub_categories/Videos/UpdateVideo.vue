                                            ...
                                            <div class="col-12" style="margin-bottom:25px;margin-top: 23px;">
                                                ...
                                                <div class="card card-info" style="margin:15px;">
                                                    <div class="card-header">
                                                        <h3 class="card-title ">Update Video </h3>
                                                        <div class="card-tools">
                                                            <router-link to="/video" class="btn btn-block btn-outline-secondary"> Video List</router-link>
                                                        </div>
                                                    </div>
                                                    <!-- /.card-header -->
                                                    <!-- form start -->
                                                    <form class="form-horizontal" @submit.prevent="UpdateVideo">
                                                        <div class="card-body">
...
export default {
    ...
    methods:{
        UpdateVideo: function (){
            let this_ = this;
            this.form.post('/updatevideo/'+ this.$route.params.name).then((response) => {
                ...
                this_.$router.push("/video");
            })

        },
        ViewVideo: function () {
            const this_ = this;
            axios.get("/viewvideo/" + this.$route.params.name).then((response) =>{
                this_.form.fill(response.data.showVideo);
