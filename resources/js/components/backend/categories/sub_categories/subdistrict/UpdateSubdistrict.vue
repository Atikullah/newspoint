                                        ...
                                        <div class="row" >
                                            <div class="col-12" style="margin-bottom:25px;margin-top: 23px;">
                                                ...
                                                <div class="card card-info" style="margin:15px;">
                                                    <div class="card-header">
                                                        <h3 class="card-title ">Add Sub Distict </h3>
                                                        <div class="card-tools">
                                                            <router-link to="/subdistrict" class="btn btn-block btn-outline-secondary">Sub Distict List</router-link>
                                                        </div>
                                                    </div>
                                                    <!-- /.card-header -->
                                                    <!-- form start -->
                                                    <form class="form-horizontal" @submit.prevent="UpdateSubdistrict">
                                                        <div class="card-body">
                                                            <div class="form-group row">
                                                                <label for="name" class="col-sm-2 col-form-label">Sub District  :</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control " id="name" placeholder="Enter Sub District Type"
...
export default {
    ...
    mounted() {
        this.ViewSubdistrict();
    },
    methods:{
        UpdateSubdistrict: function (){
            let this_ = this;
            this.form.post('/updatesubdistrict/'+ this.$route.params.name).then((response) => {
                ...
                this_.$router.push("/subdistrict");
            })

        },
        ViewSubdistrict: function () {
            const this_ = this;
            axios.get("/viewsubdistrict/" + this.$route.params.name).then((response) =>{
                this_.form.fill(response.data.showsubdistrict);
