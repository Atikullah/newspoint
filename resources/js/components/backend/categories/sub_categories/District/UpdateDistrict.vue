                                            ...
                                            <div class="col-12" style="margin-bottom:25px;margin-top: 23px;">
                                                ...
                                                <div class="card card-info" style="margin:15px;">
                                                    <div class="card-header">
                                                        ...
                                                        <div class="card-tools">
                                                            <router-link to="district" class="btn btn-block btn-outline-secondary">District List</router-link>
                                                        </div>
                                                    </div>
                                                    <!-- /.card-header -->
                                                    <!-- form start -->
                                                    <form class="form-horizontal" @submit.prevent="UpdateDistrict">
                                                        <div class="card-body">
...
export default {
    ...
    methods:{
        UpdateDistrict: function (){
            let this_ = this;
            this.form.post('/updatedistrict/'+ this.$route.params.name).then((response) => {
                ...
                this_.$router.push("/district");
            })

        },
        ViewDistrict: function () {
            const this_ = this;
            axios.get("/viewdistrict/" + this.$route.params.name).then((response) =>{
                this_.form.fill(response.data.showdistrict);
