        ...
        <section class="content">
            ...
            <div class="card" style="margin-top: -20px;">
                <div class="card-header">
                    <h3 class="card-title">Update Health</h3>
                                            ...
                                            <div class="col-12" style="margin-bottom:25px;margin-top: 23px;">
                                                ...
                                                <div class="card card-info" style="margin:15px;">
                                                    <div class="card-header">
                                                        <h3 class="card-title ">Update Health </h3>
                                                        <div class="card-tools">
                                                            <router-link to="/health" class="btn btn-block btn-outline-secondary"> Health List</router-link>
                                                        </div>
                                                    </div>
                                                    <!-- /.card-header -->
                                                    <!-- form start -->
                                                    <form class="form-horizontal" @submit.prevent="UpdateHealth">
                                                        <div class="card-body">
                                                            <div class="form-group row">
                                                                <label for="name" class="col-sm-2 col-form-label">Health Type :</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control " id="name" placeholder="Enter Health Type"
...
export default {
    ...
    methods:{
        UpdateHealth: function (){
            let this_ = this;
            this.form.post('/updatehealth/'+ this.$route.params.name).then((response) => {
                ...
                this_.$router.push("/health");
            })

        },
        ViewHealth: function () {
            const this_ = this;
            axios.get("/viewhealth/" + this.$route.params.name).then((response) =>{
                this_.form.fill(response.data.showhealth);
