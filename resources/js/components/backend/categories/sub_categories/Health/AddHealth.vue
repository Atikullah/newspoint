        ...
        <section class="content">
            ...
            <div class="card" style="margin-top: -20px;">
                <div class="card-header">
                    <h3 class="card-title">Add Health</h3>
                                        ...
                                        <div class="row" >
                                            <div class="col-12" style="margin-bottom:25px;margin-top: 23px;">
                                                ...
                                                <div class="card card-info" style="margin:15px;">
                                                    ...
                                                    <!-- /.card-header -->
                                                    <!-- form start -->
                                                    <form class="form-horizontal" @submit.prevent="AddHealth">
                                                        <div class="card-body">
                                                            <div class="form-group row">
                                                                <label for="name" class="col-sm-2 col-form-label">Health Type :</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control " id="name" placeholder="Enter Health name"
...
export default {
    ...
    methods:{
        AddHealth:function (){
            let this_ = this;
            this.form.post('/addhealth').then(function (data){
                //console.log(data);
                Toast.fire({
                    icon: 'success',
