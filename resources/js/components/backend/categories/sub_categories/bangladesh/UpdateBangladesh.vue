                                            ...
                                            <div class="col-12" style="margin-bottom:25px;margin-top: 23px;">
                                                ...
                                                <div class="card card-info" style="margin:15px;">
                                                    <div class="card-header">
                                                        <h3 class="card-title ">Update Resource </h3>
                                                        <div class="card-tools">
                                                            <router-link to="bangladesh" class="btn btn-block btn-outline-secondary">Resource List</router-link>
                                                        </div>
                                                    </div>
                                                    <!-- /.card-header -->
                                                    <!-- form start -->
                                                    <form class="form-horizontal" @submit.prevent="UpdateBangladesh">
                                                        <div class="card-body">
...
<!--                                                                <div class="col-sm-10">-->
<!--                                                                    <input type="file" name="image" class="form-control" id="image" @change="onFileChange">-->
...
export default {
    ...
    methods:{
        UpdateBangladesh: function (){
            let this_ = this;
            this.form.post('/UpdateBangladesh/'+ this.$route.params.name).then((response) => {
                ...
                this_.$router.push("/bangladesh");
            })

        },
        ViewBangladesh: function () {
            const this_ = this;
            axios.get("/viewbangladesh/" + this.$route.params.name).then((response) =>{
                this_.form.fill(response.data.showBangladesh);
