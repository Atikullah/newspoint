                                            ...
                                            <div class="col-12" style="margin-bottom:25px;margin-top: 23px;">
                                                ...
                                                <div class="card card-info" style="margin:15px;">
                                                    <div class="card-header">
                                                        <h3 class="card-title ">Update Photo </h3>
                                                        <div class="card-tools">
                                                            <router-link to="/photo" class="btn btn-block btn-outline-secondary"> Photo List</router-link>
                                                        </div>
                                                    </div>
                                                    <!-- /.card-header -->
                                                    <!-- form start -->
                                                    <form class="form-horizontal" @submit.prevent="UpdatePhoto">
                                                        <div class="card-body">
                                                            <div class="form-group row">
                                                                <label for="name" class="col-sm-2 col-form-label">Photo Name :</label>
                                                                <div class="col-sm-10">
...
export default {
    ...
    methods:{
        UpdatePhoto: function (){
            let this_ = this;
            this.form.post('/updatephoto/'+ this.$route.params.name).then((response) => {
                ...
                this_.$router.push("/photo");
            })

        },
        ViewPhoto: function () {
            const this_ = this;
            axios.get("/viewphoto/" + this.$route.params.name).then((response) =>{
                this_.form.fill(response.data.showPhoto);
