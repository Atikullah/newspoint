                                            ...
                                            <div class="col-12" style="margin-bottom:25px;margin-top: 23px;">
                                                ...
                                                <div class="card card-info" style="margin:15px;">
                                                    <div class="card-header">
                                                        <h3 class="card-title ">Update Jobs </h3>
                                                        <div class="card-tools">
                                                            <router-link to="/jobs" class="btn btn-block btn-outline-secondary">Jobs List</router-link>
                                                        </div>
                                                    </div>
                                                    <!-- /.card-header -->
                                                    <!-- form start -->
                                                    <form class="form-horizontal" @submit.prevent="UpdateJobs">
                                                        <div class="card-body">
                                                            <div class="form-group row">
                                                                <label for="name" class="col-sm-2 col-form-label">Jobs Type :</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control " id="name" placeholder="Enter Jobs Type"
...
export default {
    ...
    methods:{
        UpdateJobs: function (){
            let this_ = this;
            this.form.post('/updatejobs/'+ this.$route.params.name).then((response) => {
                ...
                this_.$router.push("/jobs");
            })

        },
        ViewJobs: function () {
            const this_ = this;
            axios.get("/viewjobs/" + this.$route.params.name).then((response) =>{
                this_.form.fill(response.data.showjobs);
