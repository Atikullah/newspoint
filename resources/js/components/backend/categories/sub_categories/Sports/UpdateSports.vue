                                            ...
                                            <div class="col-12" style="margin-bottom:25px;margin-top: 23px;">
                                                ...
                                                <div class="card card-info" style="margin:15px;">
                                                    <div class="card-header">
                                                        <h3 class="card-title ">Update Sports </h3>
                                                        <div class="card-tools">
                                                            <router-link to="/sports" class="btn btn-block btn-outline-secondary">Sports List</router-link>
                                                        </div>
                                                    </div>
                                                    <!-- /.card-header -->
                                                    <!-- form start -->
                                                    <form class="form-horizontal" @submit.prevent="UpdateSports">
                                                        <div class="card-body">
                                                            <div class="form-group row">
                                                                <label for="name" class="col-sm-2 col-form-label">Sports Type :</label>
                                                                <div class="col-sm-10">
...
export default {
    ...
    methods:{
        UpdateSports: function (){
            let this_ = this;
            this.form.post('/updatesports/'+ this.$route.params.name).then((response) => {
                ...
                this_.$router.push("/sports");
            })

        },
        ViewSports: function () {
            const this_ = this;
            axios.get("/viewsports/" + this.$route.params.name).then((response) =>{
                this_.form.fill(response.data.showsports);
