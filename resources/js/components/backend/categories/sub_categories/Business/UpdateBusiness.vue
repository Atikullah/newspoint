                                            ...
                                            <div class="col-12" style="margin-bottom:25px;margin-top: 23px;">
                                                ...
                                                <div class="card card-info" style="margin:15px;">
                                                    <div class="card-header">
                                                        <h3 class="card-title ">Update Business </h3>
                                                        <div class="card-tools">
                                                            <router-link to="/business" class="btn btn-block btn-outline-secondary">Business List</router-link>
                                                        </div>
                                                    </div>
                                                    <!-- /.card-header -->
                                                    <!-- form start -->
                                                    <form class="form-horizontal" @submit.prevent="UpdateBusiness">
                                                        <div class="card-body">
                                                            <div class="form-group row">
                                                                <label for="name" class="col-sm-2 col-form-label">Business Type :</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control " id="name" placeholder="Enter Business Type"
...
export default {
    ...
    methods:{
        UpdateBusiness: function (){
            let this_ = this;
            this.form.post('/updatebusiness/'+ this.$route.params.name).then((response) => {
                ...
                this_.$router.push("/business");
            })

        },
        ViewBusiness: function () {
            const this_ = this;
            axios.get("/viewbusiness/" + this.$route.params.name).then((response) =>{
                this_.form.fill(response.data.showbusiness);
